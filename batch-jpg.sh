...
# Update: Credit Joanna DiPasquale for current version; 
# Credit Alex Kocisky for original: https://github.com/namka/bash-scripts/blob/master/islandora-batch-import-setup.sh
